...
function calculateDamage(moveOne1, moveTwo1, moveThree1, moveFour1, moveOne2, moveTwo2, moveThree2, moveFour2) {
    ...
    let dmgMoveOneU1 = Math.floor((Math.floor((Math.floor(2 * level1.value/5) + 2) * moveOne1.power * (moveOne1.mr == "Ranged" ? atkR1/defR2 : atk1/def2)/50) + 2) * getMultiplier(firstLoom, secondLoom, moveOne1, critOne1, stat1, stat2, ability1, ability2, btl2));
    let dmgMoveOneL1 = Math.floor((Math.floor((Math.floor(2 * level1.value/5) + 2) * moveOne1.power * (moveOne1.mr == "Ranged" ? atkR1/defR2 : atk1/def2)/50) + 2) * getMultiplier(firstLoom, secondLoom, moveOne1, critOne1, stat1, stat2, ability1, ability2, btl2) * 0.85);    
